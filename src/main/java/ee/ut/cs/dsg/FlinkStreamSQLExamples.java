...
//
//
//        DataStream<Tuple4<String, Long, String, Long>> streamStreamJoinResultAsStream = tableEnv.toAppendStream(streamStreamJoinResult,streamStreamJoinResultTypeInfo );
//
